...
-- qb-target を使用（ox_target 未導入のため "ox" にすると export エラーになる）
Config.Target = "qb"    -- qb or ox

Config.RegisterSearchTime = 15000

-- true: 店舗ごとにレジから奪えるのは1回まで（成功時に他レジも使用不可）
Config.RegisterOncePerStore = true
