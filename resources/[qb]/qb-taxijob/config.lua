Config = {
    ...
    Meter = {
        ...
        ['startingPrice'] = 25000     -- static starting price
    },
    ...
    Advanced = {
        ...
        MinCabHealth = 1500,     -- min vehicle health before mission stops
    ...
    -- 業務車両貸し出し時の燃料（exports[名前]:SetFuel(vehicle, level)）。例: 'cdn-fuel', 'LegacyFuel', 'ps-fuel'
    -- false または '' なら燃料スクリプトは呼ばず SetVehicleFuelLevel のみ
    FuelResource = 'cdn-fuel',
    -- 貸し出し時の燃料量（0〜100。満タンは 100）
    SpawnFuelLevel = 100.0,
}
