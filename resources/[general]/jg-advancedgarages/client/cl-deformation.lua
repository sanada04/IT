...
-- Alias function for setVehicleDamage (same as setVehicleDeformation)
function setVehicleDamage(vehicle, damage)
  -- The damage data structure is the same as deformation data
  -- This function is called from cl-spawn.lua when applying vehicle damage
  if damage and type(damage) == "table" then
    setVehicleDeformation(vehicle, damage)
  end
end