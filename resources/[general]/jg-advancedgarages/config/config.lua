...
-- Localisation
Config.Locale = "ja"
Config.NumberAndDateFormat = "ja-JP"
Config.Currency = "JPY"

-- Framework & Integrations
Config.Framework = "QBCore" -- or "QBCore", "Qbox", "ESX"
Config.FuelSystem = "cdn-fuel" -- or "LegacyFuel", "ps-fuel", "lj-fuel", "ox_fuel", "cdn-fuel", "hyon_gas_station", "okokGasStation", "nd_fuel", "myFuel", "ti_fuel", "Renewed-Fuel", "rcore_fuel", "none"
...
Config.OpenImpoundPrompt = "[E] 保管庫を開く"
Config.InsertVehicleKeyBind = 38
Config.InsertVehiclePrompt = "[E] 車を保管する"
...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["高級車ディーラー"] = {
    coords = vector3(-1247.9885, -384.4642, 37.2894),
    spawn = vector4(-1254.3563, -389.0502, 36.8655, 299.2575),
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["EMS前"] = {
    coords = vector3(-494.5430, -962.7453, 23.5547),
    spawn = vector4(-494.6219, -953.5332, 23.2944, 180.7386),
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
...
Config.JobGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ["Mechanic"] = {
    coords = vector3(-384.8978, -124.0993, 38.6864),
    spawn = {
      vector4(-386.5809, -127.5296, 38.6495, 298.3359),
      vector4(-383.9341, -134.2558, 38.2938, 300.4769),
      vector4(-390.1948, -121.2467, 38.6381, 301.5925)
    },
    distance = 15,
    job = {"mechanic"},
    type = "car",
  ...
  ["Police"] = {
    coords = vec3(445.0095, -1018.5062, 28.6289),
    spawn = vec4(445.98, -1024.88, 27.23, 5.7),
    distance = 18,
    job = {"police"},
    type = "car",
    hideBlip = false,
...
Config.GangGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ["LOS VAGOS"] = {
    coords = vector3(326.1028, -2032.5901, 20.9225),
...
Config.ImpoundLocations = { -- IMPORTANT - Every impound name must be unique
  ["Impound A"] = {
    coords = vector3(-191.8970, -1162.2189, 23.6714),
    spawn = {
      vector4(-187.0466, -1175.1837, 22.4369, 198.4062),
      vector4(-190.5349, -1175.0970, 22.4369, 199.5232),
      vector4(-190.5349, -1175.0970, 22.4369, 199.5232)
    },
    distance = 5,
    type = "car",
...
Config.Debug = false
Config.UpdateDashboard = false -- Set to true if you want to send vehicle stats to NUI/HUD