...
Config.HUD = {
    ...
    size = {
        width = "40px", -- Indicator width (CSS value: px, %, etc.)
        height = "40px", -- Indicator height (CSS value: px, %, etc.)
    }
}
...
Config.Sounds = {
    ...
    fasten = {
        ...
        volume = 0.25, -- Volume for fasten sound (0.0 to 1.0)
    },
    unfasten = {
        enabled = true, -- Enable/disable unfasten sound
        volume = 0.25, -- Volume for unfasten sound (0.0 to 1.0)
    },
    alarm = {
        enabled = true, -- Enable/disable alarm sound
        volume = 0.25, -- Volume for alarm sound (0.0 to 1.0)
