...
--- クライアント起動直後に NUI へ確実に届ける（初回ブロードキャストより前に UI が読み込まれる場合の補填）
RegisterNetEvent('TimeAndDateDisplay-FiveM:request', function()
    local src = source
    TriggerClientEvent('TimeAndDateDisplay-FiveM', src, getTime())
end)
