...
RegisterNetEvent('ps_lib:client:playSound', playSound)
...
RegisterNetEvent('ps_lib:client:playSoundFromEntity', function(data)
...
RegisterNetEvent('ps_lib:client:playSoundFromCoords', playSoundFromCoords)