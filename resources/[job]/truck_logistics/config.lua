...
Config.webhook = ""					-- Discord webhook disabled by default for safety
Config.lang = "ja"								-- Set the file language [en/br]
Config.jobRequired = false						-- true = trucker job only / false = everyone can access
Config.jobName = "trucker"						-- Required job name when jobRequired is true

Config.formatacao = {
	['moeda'] = 'JPY',			-- This is the format of the currency, so that your currency sign appears correctly [Examples: BRL, USD]
	['location'] = 'ja-JP'		-- This is the location of your country, to format the decimal places according to your standard [Examples: pt-BR, en-US]
}
...
Config.empresas = {
	["trucker_1"] = {															-- ID
		['nome'] = "トラック運送",														-- Name
		['coordenada'] = {1208.7642, -3115.1553, 5.5403},	-- Coordinate to open the menu
...
Config.contratos = {
	...
	['cooldown'] = 2, 							-- Cooldown time (in minutes) to generate a new contract
	['preco_por_km_min'] = 8000,				-- Minimum price per kilometer of the contract (target: around 50k-150k per job)
	['preco_por_km_max'] = 15000,				-- Maximum price per kilometer of the contract (target: around 50k-150k per job)
	['multiplicador_frete'] = 1.0,				-- Multiplier applied when generating FREIGHT loads
	...
	['cargas'] = {
		...
		{ carga = "armytanker", nome = "Potassium hydroxide", def = {6,0,0}},
		{ carga = "armytanker", nome = "Nitrogen", def = {2,0,1}},
		{ carga = "armytanker", nome = "Potassium chloride", def = {5,0,0}},
		{ carga = "armytanker", nome = "Poison", def = {5,0,0}},
		{ carga = "armytanker", nome = "Pesticide", def = {5,0,0}},
		...
		{ carga = "tr4", nome = "Carros de Exposição", def = {0,1,1}},
		{ carga = "tr3", nome = "Transporte de Iate", def = {0,1,1}},
	}
}
...
Config.motoristas = {
	...
	['preco_por_km_min'] = 100,					-- Minimum starting price per KM of the driver (at the end of each delivery)
	['preco_por_km_max'] = 250,					-- Maximum initial price per KM of the driver (at the end of each delivery)
	['preco_min'] = 5000,						-- Minimum initial price of the driver (at the end of each delivery)
	['preco_max'] = 7500,						-- Maximum initial price of the driver (at the end of each delivery)
...
Config.trabalhos = {
	...
	['valor_inicial_min'] = 3500,			-- Minimum initial contract profit
	['valor_inicial_max'] = 5000,			-- Maximum initial contract profit
...
Config.blips = {
	{1208.7642, -3115.1553, 5.5403,477,4,"トラック運送",0.8 },
}