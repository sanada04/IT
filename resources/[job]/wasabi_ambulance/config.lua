...
--------------------------------------------------------------
Config.gksPhoneDistress = false -- If you use GKS Phone and want to use it for distress signals(If set to true, the default distress will be disabled regardless)
