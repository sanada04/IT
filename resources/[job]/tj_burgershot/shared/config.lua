    ...
    Locations = { -- Locations for shops
        {
            ...
            target = {
                ...
                label = 'Open ingredients',
                job = 'burgershot',
                action = function()
                    if Config.Inventory == 'ox' then
                        TriggerServerEvent('tj_burgershot:openShop', 'ingredients_shop')
    ...
    Resotrani = {
        {
            ...
            stashovi = { -- stashes
                ...
                {
                    target = {
                        coords = vector3(-1184.9730, -899.9995, 14.3805),
                        width = 1.2,
                        lenght = 3.4,
                        heading = 305,
                        minZ = 11.85,
            ...
            menu = { -- menu options
                {
                    ...
                    menuName = 'drinksMenu',
                    target = {
                        coords = vector3(-1192.4465, -899.8350, 14.3806),
                        width = 1.0,
                        lenght = 2.2,
                        heading = 305,
                        minZ = 11.97,
                ...
                },
                {
                    ...
                    target = {
                        coords = vector3(-1182.9476, -898.8254, 14.3805),
                        width = 1.0,
                        lenght = 3.2,
                        heading = 35,
                        minZ = 10.97,
                ...
                },
                {
                    ...
                    target = {
                        coords = vector3(-1183.125, -897.2, 14.3805),
                        width = 1.0,
                        lenght = 3.2,
                        heading = 35,
                        minZ = 10.97,
                ...
                },
                {
                    ...
                    menuName = 'bbq',
                    target = {
                        coords = vector3(-1188.1494, -903.2293, 15.5812),
                        width = 1.2,
                        lenght = 2.0,
                        heading = 35,
                        minZ = 10.97,
                ...
                },
                {
                    ...
                    menuName = 'deepFryer',
                    target = {
                        coords = vector3(-1188.7294, -902.5410, 14.3806),
                        width = 1.0,
                        lenght = 2.0,
                        heading = 35,
                        minZ = 10.97,
